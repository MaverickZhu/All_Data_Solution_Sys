...
class Settings(BaseSettings):
    ...
    max_upload_size: int = Field(104857600, validation_alias=AliasChoices("max_upload_size", "MAX_UPLOAD_SIZE"))  # 100MB
    allowed_extensions: List[str] = Field(default=["pdf", "docx", "txt", "csv", "xlsx", "json", "jpg", "png", "mp3", "mp4"], validation_alias=AliasChoices("allowed_extensions", "ALLOWED_EXTENSIONS"))
